...
namespace Dsw2025Tpi.Application.Dtos
{
    public record OrderModel
    {
        ...
        public record ResponseOrderModel(Guid Id, DateTime Date, string? ShippingAddress, string? BillingAddress, string? Notes, Guid CustomerId, OrderStatus Status, string CustomerName);
